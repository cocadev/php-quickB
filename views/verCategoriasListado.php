...
<script>
    $(function(){
        ...
        var table = $('#listado').DataTable({
            ...
            "serverSide": true,
            "ajax": {
                url: "/categorias/listado/ajax",
                type: "GET"
            },
            "columnDefs": [
                {"targets": 0, "data": 0, "render": function (data) {return '<a href="/categorias/detalle/' + data + '" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i></a> ' + data + '';}},
                {"targets": 1, "render": function (data) {return data;}},
                {"targets": 2, "render": function (data) {return data;}},
                {"targets": 3, "render": function (data, type, row) {return '<img src="/AppDelivery/Imagenes/'+data+'">';}}
