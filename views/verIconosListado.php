...
<script>
    $(function(){
        ...
        var table = $('#listado').DataTable({
            ...
            "serverSide": true,
            "ajax": {
                url: "/iconos/listado/ajax",
                type: "GET"
            },
            "columnDefs": [
                {"targets": 0, "data": 0, "render": function (data) {return '<a href="/iconos/detalle/' + data + '" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i></a> ' + data + '';}},
                ...
                {"targets": 4, "render": function (data, type, row) {return '<img src="/AppDelivery/Imagenes/'+data+'">';}}
                //{ "targets": 6, "render": function(data, type, row) { return row[5]; } },
