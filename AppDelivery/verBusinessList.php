 ...
 * Ejemplo https://admin.quickb.mx/Apis/Business/List
 */
...
if( ($_POST['c'] != '') && ($_POST['p'] != '') ) {
    ...
    //echo mysqli_query($FUNCIONES->conexion, $sql) or die ('Error '. mysqli_error($FUNCIONES->conexion));
